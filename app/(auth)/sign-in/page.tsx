  ...
  return (
    <main className="max-w-7xl mx-auto py-12 space-y-12">
      <section className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="space-y-6 p-4 md:p-8 rounded-xl">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <Link href="/terms" className="hover:underline text-foreground">Termos de Serviços</Link> e a{" "}
            <Link href="/privacy" className="hover:underline text-foreground">Política de Privacidade</Link>.
          </p>
        </div>
